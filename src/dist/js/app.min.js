...
"use strict";function loaderHome(){var o=$(".js-hero-image"),e=o.find(".img");$("<img/>").on("load",function(){}).on("error",function(){console.log("error loading image")}).attr("src",$(e).attr("src"));setTimeout(function(){o.addClass("active")},2e3)}$(document).ready(function(){loaderHome()});
