...
"use strict";function sectionAppear(){var a=$(".appear");$(window).scroll(function(){var e=$(this),o=e.scrollTop();a.map(function(a,e){o>=$(e).offset().top+1e3&&$(e).addClass("active")})})}function menuFixed(){var a=($(".header"),$(".top").outerHeight()),e=$("body");$(window).scroll(function(){var o=$(this).scrollTop();o>=a?e.addClass("top-fixed"):e.removeClass("top-fixed")})}function homeSlider(){var a=$(".owl-carousel");$(".hero-slider__item");a.owlCarousel({loop:!0,margin:0,nav:!0,items:1,lazyLoad:!0,smartSpeed:650,autoplay:!0,animateOut:"fadeOut",animateIn:"fadeIn",mouseDrag:!1,touchDrag:!1,navText:["",""]})}function appear(){var a=$(".appear");Modernizr.touch?a.addClass("active"):a.map(function(a,e){$(e).waypoint(function(){$(e).addClass("active")},{offset:"88%"})})}$(document).ready(function(){appear(),homeSlider(),menuFixed()}),$.validator.addMethod("regex",function(a,e,o){var t=new RegExp(o);return this.optional(e)||t.test(a)},"");
