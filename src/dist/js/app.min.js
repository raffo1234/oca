...
"use strict";function homeSlider(){var a=$(".owl-carousel");a.owlCarousel({loop:!0,margin:0,nav:!1,items:1,lazyLoad:!0,smartSpeed:650,autoplay:!0,animateOut:"fadeOut",animateIn:"fadeIn",mouseDrag:!1,touchDrag:!1})}function loaderHome(){var a=$(".js-hero-image"),e=(a.find(".img"),$(".js-button-1")),o=$(".js-button-2");setTimeout(function(){e.addClass("active")},800),setTimeout(function(){o.addClass("active")},1600)}$(document).ready(function(){loaderHome(),homeSlider()});
