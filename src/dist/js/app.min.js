...
"use strict";function sectionAppear(){var e=$(".appear");$(window).scroll(function(){var a=$(this),t=a.scrollTop();e.map(function(e,a){t>=$(a).offset().top+1e3&&$(a).addClass("active")})})}function menuFixed(){var e=($(".header"),$(".top").outerHeight()),a=$("body");$(window).scroll(function(){var t=$(this).scrollTop();t>=e?a.addClass("top-fixed"):a.removeClass("top-fixed")})}function homeSlider(){var e=$(".owl-carousel"),a=$(".hero-slider__item");a.map(function(e,a){style=a.currentStyle||window.getComputedStyle(a,!1),bi=style.backgroundImage.slice(4,-1).replace(/"/g,"")}),e.owlCarousel({loop:!0,margin:0,nav:!0,items:1,lazyLoad:!0,smartSpeed:650,autoplay:!0,animateOut:"fadeOut",animateIn:"fadeIn",mouseDrag:!1,touchDrag:!1,navText:["",""]})}function loaderSlider(){var e=$(".hero-slider"),a=($(".hero-slider__item"),$(".js-button-1")),t=$(".js-button-2");e.addClass("active"),setTimeout(function(){a.addClass("active")},800),setTimeout(function(){t.addClass("active")},1600)}function appear(){var e=$(".appear");Modernizr.touch?e.addClass("active"):e.map(function(e,a){$(a).waypoint(function(){$(a).addClass("active")},{offset:"88%"})})}$(document).ready(function(){appear(),homeSlider(),menuFixed()}),$.validator.addMethod("regex",function(e,a,t){var o=new RegExp(t);return this.optional(a)||o.test(e)},"");
