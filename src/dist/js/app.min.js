...
"use strict";function sectionAppear(){var o=$(".appear");$(window).scroll(function(){var e=$(this),a=e.scrollTop();console.log(a),o.map(function(o,e){a>=$(e).offset().top+1e3&&$(e).addClass("active")})})}function menuFixed(){var o=($(".header"),$(".top").outerHeight()),e=$("body");$(window).scroll(function(){var a=$(this).scrollTop();a>=o?e.addClass("top-fixed"):e.removeClass("top-fixed")})}function homeSlider(){var o=$(".owl-carousel");o.owlCarousel({loop:!0,margin:0,nav:!0,items:1,lazyLoad:!0,smartSpeed:650,autoplay:!0,animateOut:"fadeOut",animateIn:"fadeIn",mouseDrag:!1,touchDrag:!1,navText:["",""]})}function loaderHome(){var o=$(".hero-slider"),e=(o.find(".img"),$(".js-button-1")),a=$(".js-button-2");o.addClass("active"),setTimeout(function(){e.addClass("active")},800),setTimeout(function(){a.addClass("active")},1600)}$(document).ready(function(){homeSlider(),menuFixed()}),$(window).on("load",function(){loaderHome()}),$.validator.addMethod("regex",function(o,e,a){var t=new RegExp(a);return this.optional(e)||t.test(o)},"");
