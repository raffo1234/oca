...
"use strict";function loaderHome(){var o=$(".js-hero-image"),t=o.find(".img"),e=$(".js-button-1"),n=$(".js-button-2");$("<img/>").attr("src",$(t).attr("src")).on("load",function(){o.addClass("active"),setTimeout(function(){e.addClass("active")},800),setTimeout(function(){n.addClass("active")},1600)}).on("error",function(){console.log("error loading image")})}$(document).ready(function(){loaderHome()});
