...
"use strict";function sectionAppear(){var a=$(".appear");$(window).scroll(function(){var o=$(this),t=o.scrollTop();a.map(function(a,o){t>=$(o).offset().top+1e3&&$(o).addClass("active")})})}function menuFixed(){var a=($(".header"),$(".top").outerHeight()),o=$("body");$(window).scroll(function(){var t=$(this).scrollTop();t>=a?o.addClass("top-fixed"):o.removeClass("top-fixed")})}function homeSlider(){var a=$(".owl-carousel"),o=($(".hero-slider__item"),$(".js-button-1")),t=$(".js-button-2");a.owlCarousel({loop:!0,margin:0,nav:!0,items:1,lazyLoad:!0,smartSpeed:650,autoplay:!0,animateOut:"fadeOut",animateIn:"fadeIn",mouseDrag:!1,touchDrag:!1,navText:["",""],onInitialize:function(){setTimeout(function(){o.addClass("active")},800),setTimeout(function(){t.addClass("active")},1600)}})}function appear(){var a=$(".appear");Modernizr.touch?a.addClass("active"):a.map(function(a,o){$(o).waypoint(function(){$(o).addClass("active")},{offset:"88%"})})}function modal(){var a=$(".js--modal"),o=$(".modal__inner"),t=$(".button--open-modal"),e=$(".button--close-modal");t.on("click",function(){a.addClass("active"),o.addClass("active")}),e.on("click",function(){o.removeClass("active"),a.removeClass("active")}),a.on("click",function(){a.removeClass("active"),o.removeClass("active")}),o.on("click",function(a){a.stopPropagation()})}$(document).ready(function(){appear(),homeSlider(),menuFixed(),modal()}),$.validator.addMethod("regex",function(a,o,t){var e=new RegExp(t);return this.optional(o)||e.test(a)},"");
