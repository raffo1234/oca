...
"use strict";function sectionAppear(){var o=$(".appear");$(window).scroll(function(){var a=$(this),e=a.scrollTop();console.log(e),o.map(function(o,a){e>=$(a).offset().top+1e3&&$(a).addClass("active")})})}function menuFixed(){var o=($(".header"),$(".top").outerHeight()),a=$("body");$(window).scroll(function(){var e=$(this).scrollTop();e>=o?a.addClass("top-fixed"):a.removeClass("top-fixed")})}function homeSlider(){var o=$(".owl-carousel");o.owlCarousel({loop:!0,margin:0,nav:!0,items:1,lazyLoad:!0,smartSpeed:650,autoplay:!0,animateOut:"fadeOut",animateIn:"fadeIn",mouseDrag:!1,touchDrag:!1,navText:["",""]})}function loaderHome(){var o=$(".hero-slider"),a=(o.find(".img"),$(".js-button-1")),e=$(".js-button-2");o.addClass("active"),setTimeout(function(){a.addClass("active")},800),setTimeout(function(){e.addClass("active")},1600)}function appear(){console.log("hola");var o=$(".appear");Modernizr.touch?o.addClass("active"):o.map(function(o,a){console.log($(a)),$(a).waypoint(function(){$(a).addClass("active")},{offset:"88%"})})}$(document).ready(function(){homeSlider(),menuFixed(),appear()}),$(window).on("load",function(){loaderHome()}),$.validator.addMethod("regex",function(o,a,e){var t=new RegExp(e);return this.optional(a)||t.test(o)},"");
