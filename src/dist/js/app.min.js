...
"use strict";function menuFixed(){var e=($(".header"),$(".top").outerHeight()),o=$("body");$(window).scroll(function(){var a=$(this).scrollTop();a>=e?o.addClass("top-fixed"):o.removeClass("top-fixed")})}function homeSlider(){var e=$(".owl-carousel");e.owlCarousel({loop:!0,margin:0,nav:!1,items:1,lazyLoad:!0,smartSpeed:650,autoplay:!0,animateOut:"fadeOut",animateIn:"fadeIn",mouseDrag:!1,touchDrag:!1})}function loaderHome(){var e=$(".js-hero-image"),o=(e.find(".img"),$(".js-button-1")),a=$(".js-button-2");setTimeout(function(){o.addClass("active")},800),setTimeout(function(){a.addClass("active")},1600)}$(document).ready(function(){loaderHome(),homeSlider(),menuFixed()});
