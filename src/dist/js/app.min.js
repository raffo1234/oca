...
"use strict";function menuFixed(){var e=($(".header"),$(".top").outerHeight()),o=$("body");$(window).scroll(function(){var t=$(this).scrollTop();t>=e?o.addClass("top-fixed"):o.removeClass("top-fixed")})}function homeSlider(){var e=$(".owl-carousel");e.owlCarousel({loop:!0,margin:0,nav:!0,items:1,lazyLoad:!0,smartSpeed:650,autoplay:!0,animateOut:"fadeOut",animateIn:"fadeIn",mouseDrag:!1,touchDrag:!1,navText:["",""]})}function loaderHome(){var e=$(".hero-slider"),o=(e.find(".img"),$(".js-button-1")),t=$(".js-button-2");e.addClass("active"),setTimeout(function(){o.addClass("active")},800),setTimeout(function(){t.addClass("active")},1600)}$(document).ready(function(){homeSlider(),menuFixed()}),$(window).on("load",function(){loaderHome()}),$.validator.addMethod("regex",function(e,o,t){var a=new RegExp(t);return this.optional(o)||a.test(e)},"");
