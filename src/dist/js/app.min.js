...
"use strict";function sectionAppear(){var o=$(".appear");$(window).scroll(function(){var a=$(this),t=a.scrollTop();o.map(function(o,a){t>=$(a).offset().top+1e3&&$(a).addClass("active")})})}function menuFixed(){var o=($(".header"),$(".top").outerHeight()),a=$("body");$(window).scroll(function(){var t=$(this).scrollTop();t>=o?a.addClass("top-fixed"):a.removeClass("top-fixed")})}function homeSlider(){var o=$(".owl-carousel"),a=($(".hero-slider__item"),$(".js-button-1")),t=$(".js-button-2");o.owlCarousel({loop:!0,margin:0,nav:!0,items:1,lazyLoad:!0,smartSpeed:650,autoplay:!0,animateOut:"fadeOut",animateIn:"fadeIn",mouseDrag:!1,touchDrag:!1,navText:["",""],onInitialize:function(){setTimeout(function(){a.addClass("active")},800),setTimeout(function(){t.addClass("active")},1600)}})}function appear(){var o=$(".appear");Modernizr.touch?o.addClass("active"):o.map(function(o,a){$(a).waypoint(function(){$(a).addClass("active")},{offset:"88%"})})}function modal(){var o=$(".js--modal"),a=$(".modal__inner"),t=($(".button--open-modal"),$(".button--close-modal"));t.on("click",function(){a.removeClass("active"),setTimeout(function(){o.removeClass("active")},100)}),$("body").on("click",function(){a.removeClass("active"),o.removeClass("active")}),a.on("click",function(o){o.stopPropagation()})}$(document).ready(function(){appear(),homeSlider(),menuFixed(),modal()}),$.validator.addMethod("regex",function(o,a,t){var e=new RegExp(t);return this.optional(a)||e.test(o)},"");
