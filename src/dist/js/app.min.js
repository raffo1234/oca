...
"use strict";function sectionAppear(){var a=$(".appear");$(window).scroll(function(){var t=$(this),e=t.scrollTop();a.map(function(a,t){e>=$(t).offset().top+1e3&&$(t).addClass("active")})})}function menuFixed(){var a=($(".header"),$(".top").outerHeight()),t=$("body");$(window).scroll(function(){var e=$(this).scrollTop();e>=a?t.addClass("top-fixed"):t.removeClass("top-fixed")})}function homeSlider(){var a=$(".owl-carousel"),t=($(".hero-slider__item"),$(".js-button-1")),e=$(".js-button-2");a.owlCarousel({loop:!0,margin:0,nav:!0,items:1,lazyLoad:!0,smartSpeed:650,autoplay:!0,animateOut:"fadeOut",animateIn:"fadeIn",mouseDrag:!1,touchDrag:!1,navText:["",""],onInitialize:function(){setTimeout(function(){t.addClass("active")},800),setTimeout(function(){e.addClass("active")},1600)}})}function appear(){var a=$(".appear");Modernizr.touch?a.addClass("active"):a.map(function(a,t){$(t).waypoint(function(){$(t).addClass("active")},{offset:"88%"})})}$(document).ready(function(){appear(),homeSlider(),menuFixed()}),$.validator.addMethod("regex",function(a,t,e){var o=new RegExp(e);return this.optional(t)||o.test(a)},"");
